    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
          ...
          <span class="text-primary">Perpus Online</span>
        </a>
        <button
          type="button"
        ...
        >
          ...
          <a href="" class="btn btn-primary px-4" data-toggle="modal" data-target="#siswa">Register Siswa</a>&nbsp;
          <a href="" class="btn btn-primary px-4" data-toggle="modal" data-target="#guru">Register Guru</a>&nbsp;
          <a href="" class="btn btn-warning px-4">Login Anggota</a>
                ...
                <div class="modal-content">
                    ...
                    <br>
                    <input type="email" name="email" placeholder="email akan digunakan username" class="form-control" required>
                    <br>
                    ...
                    <select name="id_kelas" class="form-control" >
                        ...
                        <?php
                        //ambil kelas
                        $hasil_kelas=selectanggota("r_kelas order by nm_kelas asc");
                    ...
                    <br>
                    <input type="number" name="hp" placeholder="HP" class="form-control" required>
                    <br>
                ...
                <div class="modal-content">
                    ...
                    <!-- Modal Header -->
                    <div class="modal-header">
                    <h4 class="modal-title">Register Guru</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
